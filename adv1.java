...
public class adv1 {
    public static void main(String[] args) {
        String[] data= returnthedata().split("\n");
        // PART 1
        int total1 = 0;
        for (String line : data) {
            String[] allDigits = line.replaceAll("\\D", "").split("");
            total1 += Integer.parseInt(allDigits[0] + allDigits[allDigits.length - 1]);
        }
        ...
        int total2 = 0;
        for (String line : data) {
            String fixedLine = fixIt(line);
            String[] allDigits = fixedLine.replaceAll("\\D", "").split("");
            total2 += Integer.parseInt(allDigits[0] + allDigits[allDigits.length - 1]);
        }
        System.out.println(total2);
    }

    private static String fixIt(String line) {
        String[] digits = {"zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"};
        for (int num = 0; num < digits.length; num++) {
            line = line.replaceAll(digits[num], digits[num] + num + digits[num]);
        }
        return line;
    }
    private static String returnthedata(){
        String inputdata = """
        threehqv2
